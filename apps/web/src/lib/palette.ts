...
/**
 * Tailwind CSS v4 color palettes, extracted verbatim from tailwindcss/theme.css.
 * Vendored so runtime theming works without relying on Tailwind emitting
 * unused --color-* variables into the production stylesheet.
 */
export type PaletteShade = 50 | 100 | 200 | 300 | 400 | 500 | 600 | 700 | 800 | 900 | 950

export const TAILWIND_PALETTES: Record<ThemeColorName, Record<PaletteShade, string>> = {
  zinc: {

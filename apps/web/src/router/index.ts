...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/api-keys/:id',
      name: 'api-key-detail',
      component: () => import('~/pages/ApiKeyDetailPage.vue'),
      meta: { requiresAuth: true },
    },
    {
      path: '/settings',
      ...
      children: [
        ...
        },
        {
          ...
          name: 'settings-admin-project-detail',
          component: () => import('~/pages/AdminProjectDetailPage.vue'),
          meta: { requiresAuth: true, requiresAdmin: true },
        },
        {
        ...
        },
        {
          ...
          name: 'settings-admin-organization-detail',
          component: () => import('~/pages/AdminOrganizationDetailPage.vue'),
          meta: { requiresAuth: true, requiresAdmin: true },
        },
        {
          path: 'admin/api-keys',
        ...
        },
        {
          ...
          name: 'settings-admin-api-key-detail',
          component: () => import('~/pages/ApiKeyDetailPage.vue'),
          meta: { requiresAuth: true, requiresAdmin: true },
        },
        {
        ...
        {
          path: 'admin/users/:id',
          name: 'settings-admin-user-detail',
